...
# A veyron_agency modul hozzáadása a path-hoz
sys.path.append(os.path.abspath('veyron_agency'))

# Importálások a veyron_agency mappából
from agency_swarm import Agency
from veyron_agency.ceo_agent.ceo_agent import CEOAgent
from veyron_agency.content_agent.content_agent import ContentAgent
from veyron_agency.media_agent.media_agent import MediaAgent
...
app = Flask(__name__, 
            static_folder='veyron_agency/static', 
            template_folder='veyron_agency/templates')

# Alapvető konfigurációk
app.config['MAX_CONTENT_LENGTH'] = 16 * 1024 * 1024  # 16 MB max feltöltési méret
app.config['UPLOAD_FOLDER'] = 'veyron_agency/uploads'
...
agency = Agency(
    ...
    shared_instructions="veyron_agency/agency_manifesto.md",
    temperature=0.5,
...
def send_static(path):
    return send_from_directory('veyron_agency/static', path)
